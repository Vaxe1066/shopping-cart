    ...
    return (
        <div className={"header"}>
            <div className="shop-name">
                <NavLink className="shop-name-link" to="/shopping-cart"  exact><h1>Salvidged Apparel</h1></NavLink>
            </div>
            <div className="navbar"> 
                <ul>
                    <li className="home-item"> <NavLink className="nav-link" to="/shopping-cart" exact activeStyle={{fontWeight: "bold",color: "#6BDEED"}}>Home</NavLink> </li>
